...
| Executable revision / prompt / Skill / adapter / rubric | Offline core exists in prototype/run_timing; it has no native launcher. Native binding, revised prompt/Skill, qualified adapter and rubric remain UNSET. Historical runner/Skill are not approved. |
