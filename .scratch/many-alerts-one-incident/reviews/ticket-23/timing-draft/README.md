...
| Synthetic Incident store and mutation receipts | Supervisor-owned; capabilities only, no live route | In-process empty baseline, append-only Reports and simulated effects implemented/tested; native write binding remains unimplemented |
