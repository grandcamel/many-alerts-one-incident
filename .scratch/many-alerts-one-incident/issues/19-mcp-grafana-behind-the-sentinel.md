...
[Outcome](../reviews/ticket-19/c1-attempt-4-outcome.md): the explicitly approved bounded run completed 7/7 positive and 13/13 negative cases, direct authority/revocation checks and final snapshots. Retained native MCP payloads and all 42 dispatched request chains were verified (40 exact responses, 2 expected transformations); independent Docker read-back confirms cleanup and base-image preservation. Large Tempo text was retained exactly; denied-request identity remains a named receipt gap. Full C1 matrix, real-backend/model/venue qualification and C2 remain incomplete. The single execution approval is consumed, with no fifth attempt authorized. Ticket 19 remains claimed, ticket 12 blocked, reservations unchanged.

## C2 operator source integration — 2026-09-21 UTC

[Preparation outcome](../reviews/ticket-19/c2-operator-integration-outcome.md): the resolved four-service configuration compiler and injected seed/read-back driver are connected through actual compiler output and offline failure tests. Runtime configuration compatibility, real bounded transport, durable ingestion intent, account lifecycle and native policy remain unimplemented or unverified. The requested Fable invocation was rejected by the provider safeguard without a review; that requirement remains incomplete. No C2 runtime ran or was authorized. Ticket 19 remains claimed, ticket 12 blocked, with qualification and reservation boundaries unchanged.

## C2 transport and journal preparation — 2026-09-21 UTC

[Source outcome](../reviews/ticket-19/c2-transport-journal-outcome.md): direct numeric HTTP transport and a one-shot durable ingestion journal are integrated through the real compiler and driver, using in-memory wire peers and private temporary files. The full suite passes 560 tests with 36 skipped; Ruff passes. Sol passed the bounded source review; the corrected `moonshotai/kimi-k3` review is recorded in the outcome. Fixed-length HTTP framing is the supported subset; actual backend compatibility, operator materialization/ownership, account lifecycle and native policy remain unverified or unimplemented. No C2 runtime, ticket resolution, blocker removal or spend-reservation release follows.

## C2 file materialization and ownership preparation — 2026-09-21 UTC

[Source outcome](../reviews/ticket-19/c2-materialization-ownership-outcome.md): one-shot private configuration staging and exact receipt-bound cleanup selection are committed locally at prototype `6261ac8`. Full suite **583 passed, 36 skipped**; Ruff and Sol adversarial review pass. The fresh correct-provider Kimi review timed out without an opinion. Missing attachment inspection and FIFO substitution failures were corrected before validation. No engine creation/deletion, backend request or C2 runtime occurred. Durable engine receipts/executor, account lifecycle, native policy and compatibility execution card remain preparation work; runtime gates, ticket status and reservations remain unchanged.

## Approved C2 compatibility attempt 1 — 2026-09-21 UTC

[Outcome](../reviews/ticket-19/c2-attempt-1-outcome.md): the single approved attempt stopped at Grafana's post-create identity/command inspection, before startup. The exact failing subpredicate is unresolved because two compared fields were not retained. One container and one network were removed; independent read-back confirms cleanup, temporary-password deletion, pinned-image preservation and unchanged preexisting inventories. No backend request, seed or native/model run occurred. Source is local at prototype `8797b16` (592 passed, 36 skipped); 30 private executor/verifier tests passed, with usable Fable findings corrected and Sol final source review passed. The consumed attempt root must not be reused; no automatic retry is authorized. Next preparation is complete inspection evidence and a corrected pinned-image verifier. Ticket 19 remains claimed and ticket 12 blocked.

## C2 inspection correction preparation — 2026-09-21 UTC

[Source outcome](../reviews/ticket-19/c2-inspection-correction-outcome.md): the candidate retains named inspection predicates before admission and independently verifies pinned-image identity. Sol's two diagnostic findings were corrected; private suite70passed, full prototype592passed/36skipped and main241passed/36skipped. Requested Fable returned an Opus fallback PASS; native telemetry proves Fable output0, so genuine Fable review remains incomplete. Attempt2 has a fresh run ID/root and closed execution gate; no runtime occurred. Prior preparation/runtime artifacts read back unchanged. Ticket19 stays claimed, ticket12 blocked, qualification and reservation boundaries unchanged.

## C2 Fable refusal diagnosis — 2026-09-21 UTC

[Native diagnosis](../reviews/ticket-19/c2-fable-refusal-diagnosis.md): the apparent Fable review fell back after an explicit provider safeguard refusal (`cyber`), not a confirmed capacity/auth failure. Fable output0; Opus produced the PASS. No model retry or C2 runtime occurred. Final corrected source and Sol PASS remain intact; all33 prior artifact entries verified unchanged. Next requires the user's explicit acceptance of Sol in place of Fable for this correction and the exact bounded attempt2 card. Execution stays closed; ticket/blocker/qualification/reservation boundaries unchanged.

## Approved C2 compatibility attempt 2 — 2026-09-21 UTC

[Outcome](../reviews/ticket-19/c2-attempt-2-outcome.md): under the approved scoped Sol-for-Fable exception, the single run passed all four post-create identity checks and start commands, then stopped when Tempo exited. Logs identify writes to /var/tempo on the read-only root; Loki also reports internal gRPC connection failures despite later readiness200 responses. Independent verification confirms all five receipt resources absent, password removed, pinned image preserved and preexisting inventories unchanged. No full four-service readiness, seed/account/native/model qualification or attempt3 occurred. Private79tests and full prototype592passed/36skipped; Sol activation passed. Next source preparation is bounded Tempo paths and Loki listener/advertisement alignment. Ticket19 stays claimed, ticket12 blocked, C1 gaps and reservation boundaries unchanged.

## C2 backend configuration correction — 2026-09-21 UTC

[Source outcome](../reviews/ticket-19/c2-backend-config-correction.md): prototype `817f466` relocates Tempo live-store marker/WAL and scheduler work beneath the existing data tmpfs and aligns Loki self-advertisement with its unchanged loopback gRPC listener. All other container-spec fields and limits are unchanged. Full suite595passed/36skipped; final Sol source review PASS after supplementing omitted pinned-source excerpts. A fresh requested Fable review again received a cyber safeguard refusal with automatic Opus fallback; no usable Fable opinion, retry or waiver follows. The [attempt3 card](../reviews/ticket-19/c2-attempt-3-card.md) freezes a fresh identity/root and exact unchanged compatibility scope, pending explicit scoped reviewer exception and one-run approval. No attempt3 harness activation or runtime occurred. Ticket19 remains claimed, ticket12 blocked, C1 gaps and qualification/reservation boundaries unchanged.

## Approved C2 compatibility attempt 3 — 2026-09-21 UTC

[Outcome](../reviews/ticket-19/c2-attempt-3-outcome.md): the explicitly approved run completed COMPATIBILITY_OBSERVED in48.087seconds with no runtime or independent-verifier problems. All40 created and40 running identity predicates passed; allfour services returnedHTTP200 in the sixth readiness round; per-backend version/process/listener/mount/top/diff/log evidence was retained. Independent checks verify5receipt resources absent, temporary password removed, pinned image preserved and preexisting15containers/6networks/70images/14volumes unchanged;244commandpayload hashes and158finalruntimeartifact entries read back. Private81tests, fullprototype595passed/36skipped, scopedlint and finalSolactivationPASS. This is bounded backend compatibility, not fullC2/Eyes: no ingestion/account/strict-adapter/native/model qualification ran. The scopedSol exception and one-run approval are consumed. Next preparation is real HTTP/seed-oracle integration and a separate execution card; ticket19claimed12blocked,C1gaps/reservationsunchanged.
